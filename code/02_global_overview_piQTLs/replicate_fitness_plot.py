...
if __name__ == "__main__":
    ...
    for TABLE in [all_A_vs_B, MTX, noMTX]:
        ...
        f.savefig(f'../manuscript/figures/EXT_FIGURE_3/duplicate_density_plot_{title[i]}.png', dpi=300)
        f.savefig(f'../manuscript/figures/EXT_FIGURE_3/duplicate_density_plot_{title[i]}.eps', dpi=300)
        i += 1
