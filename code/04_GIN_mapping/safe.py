...
class SAFE:
    ...
    def load_network_for_piQTLs(self, **kwargs):
        """
    ...
    def plot_network_for_piQTLs(self, show_network=False, show_costanzo2016=True,show_costanzo2016_colors=True, show_costanzo2016_clabels=True, background_color='#ffffff', PPI_label='', DRUG='', PPI=list(), piQTLs=list(), save_fig=''):
        ...
        if save_fig:
            ...
            plt.savefig(path_to_fig, facecolor=background_color, format='pdf')
    ...
    def plot_sample_attributes(self, attributes=1, top_attributes_only=False,
                               show_network=True,
                               show_costanzo2016=False, show_costanzo2016_colors=True, show_costanzo2016_clabels=True,
